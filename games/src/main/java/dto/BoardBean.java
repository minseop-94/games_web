...
public class BoardBean {
	...
	public BoardBean(int board_num, String board_name, String board_pass, String board_subject, String board_content,
			String board_file, int board_re_ref, int board_re_lev, int board_re_step, int board_readcount,
			Date board_date) {		
	...
	public String toString() {
		return "BoardBean [board_num=" + board_num + ", board_name=" + board_name + ", board_pass=" + board_pass
				...
				+ ", board_re_ref=" + board_re_ref + ", board_re_lev=" + board_re_lev + ", board_re_step="
				+ board_re_step + ", board_readcount=" + board_readcount + ", board_date=" + board_date + "]";
	}
