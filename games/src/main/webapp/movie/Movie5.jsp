...
<body onload="assassination();" bgcolor = "#212121">
...
<table id = table1>
	...
	<img id="cinema" src=./images/assassin_blur.jpg>
...
<form action = "end.mo" method = "post" name = "form">
	<table>
	<tr>
		<td> 정답 : &nbsp;
		...
		<td>
			...
			<input type='button' class="w-btn w-btn-indigo" style="WIDTH: 60pt; HEIGHT: 30pt; font-size: 12pt;" value='정답확인' onclick="return confirm5()">&nbsp;
