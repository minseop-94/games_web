...
<body onload="veteran();" bgcolor = "#212121">
...
<table id = table1>
	...
	<img id="cinema" src=./images/veteran_blur.jpg>
...
<form action = "movie5.mo" method = "post" name = "form">
	<table>
	<tr>
		<td> 정답 : &nbsp;
		...
		<td>
			...
			<input type='button' class="w-btn w-btn-indigo" style="WIDTH: 60pt; HEIGHT: 30pt; font-size: 12pt;" value='정답확인' onclick="return confirm4()">&nbsp;
