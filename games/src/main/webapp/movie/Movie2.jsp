...
<body onload="extremejob();" bgcolor = "#212121">
...
<table id = table1>
	...
	<img id="cinema" src=./images/extremjob_blur.jpg>
...
<form action = "movie3.mo" method = "post" name = "form">
	<table>
	<tr>
		<td> 정답 : &nbsp;
		...
		<td>
			...
			<input type='button' class="w-btn w-btn-indigo" style="WIDTH: 60pt; HEIGHT: 30pt; font-size: 13pt;" value='정답확인' onclick="return confirm2()">&nbsp;
			<input type='submit' class="w-btn w-btn-indigo" style="WIDTH: 60pt; HEIGHT: 30pt; font-size: 13pt;" value='다음문제'>&nbsp;
		</td>
